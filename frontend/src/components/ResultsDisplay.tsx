    ...
    <div className="w-full max-w-3xl px-4 py-12 animate-in fade-in slide-in-from-bottom-4 duration-700">
      <div className="glass glow p-10 space-y-8">
        <div className="space-y-2">
          <span className="text-xs font-bold uppercase tracking-[0.2em] text-indigo-400">Headline</span>
          <h2 className="text-4xl font-extrabold leading-tight text-white">{data.headline}</h2>
        </div>
        
        <div className="space-y-2 text-indigo-100/80">
           <span className="text-xs font-bold uppercase tracking-[0.2em] text-indigo-400">Body Copy</span>
           <p className="text-lg leading-relaxed">{data.body_copy}</p>
        </div>

        <div className="space-y-2">
           <span className="text-xs font-bold uppercase tracking-[0.2em] text-indigo-400">Call to Action</span>
           <p className="text-xl font-semibold text-indigo-300">{data.action_item}</p>
        </div>
